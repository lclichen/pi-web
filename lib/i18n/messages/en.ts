...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "暂无快速会话——每次选择模板都会新建一个独立会话。": "No quick sessions yet — every template pick starts a NEW session.",
    "新建快速会话": "New quick session",
    "选模板新建快速会话": "Pick a template to start a new quick session",
    "配置模板": "Config bundles",
    "不使用模板": "No template",
    "测试中…": "Testing…",
