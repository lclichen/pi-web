...
echo "=== build ==="
if npm run build > /tmp/b0909.log 2>&1; then echo BUILD-OK
...
else echo BUILD-FAILED; tail -15 /tmp/b0909.log; fi
} > /tmp/deploy0909.log 2>&1 </dev/null
cat /tmp/deploy0909.log
exit 0
`;
