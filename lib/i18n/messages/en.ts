...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "填写远程主机上该项目的工作目录（Agent 侧路径，例如 /root/projects/demo；留空则使用远程 home）。": "Enter the project working directory on the remote host (agent-side path, e.g. /root/projects/demo; empty = remote home).",
