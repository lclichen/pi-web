...
> 已 cherry-pick **59 个**高价值提交（六批）；另经核对，**v0.9.0 squash 合并（`a249552`）已带入 51 个提交的内容**（见文末 09-22 更新）。
...
> 其余待定：`f2d600b`（/auto-compact）、`5e9b997`（PDF 页码跳转）、`6d53fd5`+`6e95fba`（provider 配额）、`3e9fcfa`（iOS 推送）。
