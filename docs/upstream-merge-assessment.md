...
> 已 cherry-pick **47 个**高价值提交（五批）；另经核对，**v0.9.0 squash 合并（`a249552`）已带入 51 个提交的内容**（见文末 09-22 更新）。
...
1. **中等档已清空**（第五批 12 个 + ef51ffd 判定 fork 已覆盖）
2. **下次合并窗口**：`ed50d88`（侧栏拖拽调宽）、`448e146`（主题系统，最大）、`ffb2daf`（文件面板全宽）等大 UI 功能
