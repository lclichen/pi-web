...
// /api/agent-relay/rpc and /rpc/stream routes.
...
export class AgentUnavailableError extends Error {
  constructor() {
    super("No local agent connected");
 ...
 * with the terminal `result`. Used by long-running methods (Phase 2:
 * exec.stream, pty.*, search.grep streaming).
 */
