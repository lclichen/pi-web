...
// DELETE /api/admin/workspaces/[id] — admin deletes any user's cloud
// workspace (platform requireOwned grants admins cross-user rights and
...
export async function DELETE(req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    await platformDelete<void>(`/api/v1/workspaces/${id}`, identity.session.apiKey);
